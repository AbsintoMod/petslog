...
<html>
	...
	<body>
		...
		<div id="cadastro">
		<h1 align="center">SISTEMA DE CADASTRAMENTO DE USUARIO</h1>
		<br/>
		<h2>Cadastro Login</h2>
			<form name="cad" method="POST" action="php/insere.php">
				<fieldset>
					<legend>LOGIN</legend>
					...
					<label>SENHA</label>
					<br>
					<input type="text" name="nmSENHA"/>
					<br>
					<br>
					<input type="submit" name="nmVALIDAR" value="Cadastrar"/>
					<input type="reset" name="nmCANCELAR" value="Limpar"/>
				</fieldset>
			</form>
		</div>
		<div id="rodape">
